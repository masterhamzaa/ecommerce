                ...
                <div
                    ...
                    <div class="px-5 pb-5">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-3xl font-bold text-gray-900 dark:text-white">{{ $product->price }} DH</span>
                            <a href="{{ route('addtocart', ['pid' => $product->id, 'name' => $product->name, 'desc' => $product->desc, 'price' => $product->price, 'image' => $product->image, 'uid' => Auth::user()->id]) }}"
